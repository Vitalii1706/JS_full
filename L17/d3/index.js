...
export const sayBruceName = sayName.bind(student2, student.name);
sayBruceName();
/* ===> 2 <=== */
const company = {
 ...
 */
export const specialGreeting = greeting.bind(
  company,
  'Bob',
  'Marley',
  company.companyName
 ...
 */
export const getUkrainePopulation = getPopulation.bind(
  country,
  43000,
  country.countryName
);
